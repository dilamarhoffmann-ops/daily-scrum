...
Object.assign(window, {
  ...
  removeDailyActivity,
  updateDailyActivity,
  renderTaskSuggestionsContent,
  selectTaskSuggestion,
  editDaily,
  deleteDaily,
  renderAvazaProjectsPage,
  renderAvazaTasksPage,
  toggleAvazaTask,
  renderAvazaSchedulePage,
  renderAvazaAgendaPage,
  renderAvazaReportsPage,
  toggleSelectAllRows,
  renderHelpContent,
  deleteUser,
  confirmDoubleDelete,
